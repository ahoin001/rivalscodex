  ...
  return (
    <div className="space-y-4">
      <a
        ...
        className="inline-flex items-center gap-2 rounded border border-brand-gold/40 bg-brand-gold/10 px-3 py-1.5 font-display text-[11px] font-bold uppercase italic tracking-[0.16em] text-rivals-ink hover:bg-brand-gold/20"
      >
        ...
        <div className="space-y-3">
          <div className="rounded-lg border border-rivals-light-300 bg-white/75 p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-rivals-ink-soft sm:text-[15px]">
              Use the full codex panel above for baseline tooltips, then add kit-specific tech in admin.
            </p>
          </div>
