...
const detailBodyBandClass =
  "min-h-0 flex-1 overflow-y-auto bg-[#1f2533] px-4 pb-5 pt-3 sm:px-6 sm:pb-7 sm:pt-4 [&::-webkit-scrollbar]:w-1 [&::-webkit-scrollbar-thumb]:bg-[#fc3] [&::-webkit-scrollbar-track]:bg-[#8893a8]/35 [&::-webkit-scrollbar-track]:bg-no-repeat [&::-webkit-scrollbar-track]:bg-center [&::-webkit-scrollbar-track]:bg-cover";
