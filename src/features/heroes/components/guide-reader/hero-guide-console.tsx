...
const GUIDE_SECTION_NAV_CHIP =
  "inline-flex min-h-9 items-center rounded-full border border-rivals-light-300 bg-white/70 px-3 py-1 text-[11px] font-display font-semibold uppercase tracking-[0.14em] text-rivals-ink-soft transition-[transform,color,border-color,background-color] duration-[var(--motion-fast)] ease-[var(--ease-out-soft)] hover:-translate-y-0.5 hover:border-rivals-yellow-500/55 hover:text-rivals-ink";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex w-full max-w-[min(100%,1680px)] flex-col gap-6 px-4 pt-5 pb-0 sm:min-h-[30rem] sm:gap-8 sm:px-8 sm:pt-6 lg:min-h-[32rem] lg:gap-10 lg:px-12 lg:pt-7">
        <header className="flex flex-wrap items-end justify-between gap-3 drop-shadow-[0_2px_18px_rgba(0,0,0,0.55)]">
          <div className="min-w-0 space-y-2">
            <p className="font-display text-[11px] font-bold uppercase italic tracking-[0.36em] text-brand-gold sm:text-xs">
              Hero Guide
            </p>
            <h2 className="sr-only">{heroName} guide chapters</h2>
            {subtitle ? (
